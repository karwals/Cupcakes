...
const DotGrid = ({
  ...
  const pushDuration = useMemo(() => {
    const normalized = Math.max(200, Math.min(1400, resistance));
    return Math.max(0.2, Math.min(0.7, 700 / normalized));
  }, [resistance]);
  ...
  }, [maxSpeed, speedTrigger, proximity, pushDuration, returnDuration, shockRadius, shockStrength]);
